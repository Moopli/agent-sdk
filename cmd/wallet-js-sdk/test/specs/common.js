...
export const MSG_TYPE_OFFER_CREDENTIAL_V2 =
  "https://didcomm.org/issue-credential/2.0/offer-credential";
export const MSG_TYPE_OFFER_CREDENTIAL_V3 =
  "https://didcomm.org/issue-credential/3.0/offer-credential";
export const MSG_TYPE_PROPOSE_CREDENTIAL_V2 =
  "https://didcomm.org/issue-credential/2.0/propose-credential";
export const MSG_TYPE_PROPOSE_CREDENTIAL_V3 =
...
export async function loadFrameworks({
  ...
  agentOpts["gnap-priv-jwk-raw"] = gnapKey;
